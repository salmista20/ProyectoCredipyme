						...
						<div class="card component-card_1">
							...
							<div class="card-body">
								...
								<DataTable
									...
									:filters="filters"
									:globalFilterFields="['subcategoria']"
									:paginator="false"
			...
			>
				<div class="row">
					<div class="form-group">
						<label class="label-title">SUBCATEGORIA</label>
						<input
							type="text"
							class="form-control mayus"
							v-model="frmDatosCategoria.subcategoria"
							:class="[
								submited
									? v$.frmDatosaSubcategoria.subcategoria.$invalid
										? 'is-invalid'
										: 'is-valid'
									: '',
							]"
